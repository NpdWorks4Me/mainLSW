...
const ECOMMERCE_STORE_ID = "store_01K2TB1C4RB44MWC0BSAJVY4BY";
...
export async function initializeCheckout({items, successUrl, cancelUrl, locale}) {
	// Use local server-side route to create a Stripe Checkout session
	const url = `/api/checkout/stripe/session`;
